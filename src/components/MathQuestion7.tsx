      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4 text-foreground">
          <p className="leading-relaxed pl-6">
            <span className="font-semibold">(c)</span> Find the speed of the particle at time <span className="italic">t</span> = 4. Find the acceleration vector of the particle at time <span className="italic">t</span> = 4.
          </p>
        </div>
      </div>
    </div>
