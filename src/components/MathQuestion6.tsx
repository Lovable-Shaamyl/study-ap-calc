      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4 text-foreground">
          <p className="leading-relaxed pl-6">
            <span className="font-semibold">(b)</span> Find the <span className="italic">x</span>-coordinate of the particle's position at time <span className="italic">t</span> = 4.
          </p>
        </div>
      </div>
    </div>
